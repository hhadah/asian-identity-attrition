\begin{table}[H]
\centering\centering
\caption{Asian Self-identification by Generation \label{tab:asianbygen-adults}}
\centering
\begin{threeparttable}
\begin{tabular}[t]{>{}lcccc}
\toprule
  & \specialcell{Self-identify \\ as Asian} & \specialcell{Self-identify as \\ not-only-Asian} & \specialcell{\% Self-identify \\ as Asian} & \specialcell{\% Self-identify \\ as not-only-Asian}\\
\midrule
