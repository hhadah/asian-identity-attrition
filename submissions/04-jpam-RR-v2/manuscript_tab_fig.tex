...
% Pooled: Second Generation
\begin{center}
\begin{figure}[!htb]
\centering
\caption{Marginal Effects of Key Covariates on Racial Identity Choice (Pooled Second-Generation Asian Americans)}
\label{fig:marginal-effects-second-pooled}
\includegraphics[width=0.65\linewidth]{boot_me_second_AW_WA.png}
...
\begin{figure}[!htb]
\centering
\caption{Marginal Effects of Key Covariates on Racial Identity Choice (Pooled Adult Second-Generation Asian Americans)}
...
% Pooled: Third Generation
\begin{center}
\begin{figure}[!htb]
\centering
\caption{Marginal Effects of Key Covariates on Racial Identity Choice (Pooled Third-Generation Asian Americans)}
\label{fig:marginal-effects-third-pooled}
\includegraphics[width=0.65\linewidth]{boot_me_third_oneTwoThreeAsian.png}
...
\centering
\includegraphics[width=1\linewidth]{interaction_coefficients_AW_adults.png}
\end{subfigure}
\hfill
\begin{subfigure}{.48\textwidth}
\caption{White Fathers-Asian Mothers}
\centering
\includegraphics[width=1\linewidth]{interaction_coefficients_WA_adults.png}
\end{subfigure}
