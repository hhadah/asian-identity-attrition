...
\toprule
\multicolumn{1}{c}{Parents Type} & \multicolumn{1}{c}{All} & \multicolumn{1}{c}{\makecell[c]{Both Parents \\ from Asian Country \\ (AA)}} & \multicolumn{1}{c}{\makecell[c]{Father \\ from Asian Country \\ (AW)}} & \multicolumn{1}{c}{\makecell[c]{Mother  \\ from Asian Country \\ (WA)}} \\
\cmidrule(l{3pt}r{3pt}){1-1} \cmidrule(l{3pt}r{3pt}){2-2} \cmidrule(l{3pt}r{3pt}){3-3} \cmidrule(l{3pt}r{3pt}){4-4} \cmidrule(l{3pt}r{3pt}){5-5}
  & \specialcell{(1) \\ $A^2$} & \specialcell{(2) \\ $A^2$} & \specialcell{(3) \\ $A^2$} & \specialcell{(4) \\ $A^2$}\\
\midrule
