...
\begin{figure}[!htb]
\centering
\caption{Predicted Probabilities: Second Generation Asian Father-White Mother (AW)}
...
\begin{figure}[!htb]
\centering
\caption{Predicted Probabilities: Third Generation One Asian Grandparent}
...
% \input{tab06-regression_tab_byproxy_skin.tex}
% \pagebreak
% \newpage
