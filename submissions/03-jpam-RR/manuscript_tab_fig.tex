...
\input{tab45-iat_regression_tab_bygrandparent_type}
...
\centering
\includegraphics[width=1\linewidth]{boot_pp_all_generations_value.png}
\end{subfigure}
\hfill
\begin{subfigure}{.48\textwidth}
\caption{Female}
\centering
\includegraphics[width=1\linewidth]{boot_pp_all_generations_Female.png}
\end{subfigure}
...
\caption{Anti-Asian Bias}
\centering
\includegraphics[width=1\linewidth]{boot_pp_third_threeAsian_value.png}
\end{subfigure}
\hfill
\begin{subfigure}{.48\textwidth}
\caption{Female}
\centering
\includegraphics[width=1\linewidth]{boot_pp_third_threeAsian_Female.png}
\end{subfigure}
...
\caption{College Graduate: Mother}
\centering
\includegraphics[width=1\linewidth]{boot_pp_third_threeAsian_MomGradCollege.png}
\end{subfigure}
\hfill
\begin{subfigure}{.48\textwidth}
\caption{College Graduate: Father}
\centering
\includegraphics[width=1\linewidth]{boot_pp_third_threeAsian_DadGradCollege.png}
\end{subfigure}
