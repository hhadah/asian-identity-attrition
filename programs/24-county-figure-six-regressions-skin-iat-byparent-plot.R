...
# open data
CPS_IAT <- read_csv(file.path(datasets,"CPS_IAT_asian_county.csv"))
...
p1
ggsave(paste0(figures_wd,"/county-by-parents-regs-all.png"), width = 10, height = 4, units = "in")
ggsave(paste0(thesis_plots,"/county-by-parents-regs-all.png"), width = 10, height = 4, units = "in")
...
p2
ggsave(paste0(figures_wd,"/county-by-parents-regs-hh.png"), width = 10, height = 4, units = "in")
ggsave(paste0(thesis_plots,"/county-by-parents-regs-hh.png"), width = 10, height = 4, units = "in")
...
p3
ggsave(paste0(figures_wd,"/county-by-parents-regs-hw.png"), width = 10, height = 4, units = "in")
ggsave(paste0(thesis_plots,"/county-by-parents-regs-hw.png"), width = 10, height = 4, units = "in")
...
p4 <- modelplot(reg1[[4]],
  ...
  theme(
    ...
    axis.title.x = element_text(size = 20)) 
p4
ggsave(paste0(figures_wd,"/county-by-parents-regs-wh.png"), width = 10, height = 4, units = "in")
ggsave(paste0(thesis_plots,"/county-by-parents-regs-wh.png"), width = 10, height = 4, units = "in")
...
ggsave(paste0(figures_wd,"/county-by-parents-regs-together2.png"), width = 10, height = 4, units = "in")
ggsave(paste0(thesis_plots,"/county-by-parents-regs-together2.png"), width = 10, height = 4, units = "in")
