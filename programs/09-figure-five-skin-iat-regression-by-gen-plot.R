...
p2 <- p2 + labs(title = "First Generation")
p3 <- p3 + labs(title = "Second Generation")
p4 <- p4 + labs(title = "Third Generation")

(p1 | p2) / (p3 | p4)
ggview()
ggsave(paste0(figures_wd,"/skin-iat-regression-together.png"), width = 16, height = 4, units = "in")
