...
ggsave(paste0(figures_wd,"/msa-skin-iat-regression-interaction-bygen-plot-WW.png"), width = 10, height = 4, units = "in")
ggsave(paste0(thesis_plots,"/msa-skin-iat-regression-interaction-bygen-plot-WW.png"), width = 10, height = 4, units = "in")
...
modelplot(reg1[[2]],
  ...
  theme(axis.text = element_text(size = 20)) 
ggsave(paste0(figures_wd,"/msa-skin-iat-regression-interaction-bygen-plot-WH.png"), width = 10, height = 4, units = "in")
ggsave(paste0(thesis_plots,"/msa-skin-iat-regression-interaction-bygen-plot-WH.png"), width = 10, height = 4, units = "in")
...
modelplot(reg1[[2]],
  ...
  # labs(title = "Asian Paternal Grandfather and White Paternal Grandmother") +
  theme(axis.text = element_text(size = 20)) 
ggsave(paste0(figures_wd,"/msa-skin-iat-regression-interaction-bygen-plot-HW.png"), width = 10, height = 4, units = "in")
ggsave(paste0(thesis_plots,"/msa-skin-iat-regression-interaction-bygen-plot-HW.png"), width = 10, height = 4, units = "in")
...
modelplot(reg1[[2]],
  ...
  # labs(title = "Asian Paternal Grandfather and Asian Paternal Grandmother") +
  theme(axis.text = element_text(size = 20)) 
ggsave(paste0(figures_wd,"/msa-skin-iat-regression-interaction-bygen-plot-HH.png"), width = 10, height = 4, units = "in")
ggsave(paste0(thesis_plots,"/msa-skin-iat-regression-interaction-bygen-plot-HH.png"), width = 10, height = 4, units = "in")
