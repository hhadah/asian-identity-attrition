...
p1
ggsave(paste0(figures_wd,"/county-skin-iat-regression-all-gens.png"), width = 10, height = 4, units = "in")
ggsave(paste0(thesis_plots,"/county-skin-iat-regression-all-gens.png"), width = 10, height = 4, units = "in")
...
p2
ggsave(paste0(figures_wd,"/county-skin-iat-regression-first-gen.png"), width = 10, height = 4, units = "in")
ggsave(paste0(thesis_plots,"/county-skin-iat-regression-first-gen.png"), width = 10, height = 4, units = "in")
...
p3
ggsave(paste0(figures_wd,"/county-skin-iat-regression-second-gen.png"), width = 10, height = 4, units = "in")
ggsave(paste0(thesis_plots,"/county-skin-iat-regression-second-gen.png"), width = 10, height = 4, units = "in")
...
p4 <-modelplot(reg1[[4]],
  ...
  theme(
        ...
        axis.title.x = element_text(size = 20)) 
p4
ggsave(paste0(figures_wd,"/county-skin-iat-regression-third-gen.png"), width = 10, height = 4, units = "in")
ggsave(paste0(thesis_plots,"/county-skin-iat-regression-third-gen.png"), width = 10, height = 4, units = "in")
